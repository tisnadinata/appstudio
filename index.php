                ...
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h2>Beautifully designed and good system</h2>
                                    <p>We do the best for your website. </p>
                                    <a class="btn btn-primary btn-lg" href="#">Contact Us</a>
                                </div>
                            </div>
                        </div>
    ...
    <section id="portfolio">
        <div class="container">
            ...
            <div class="portfolio-items">
                ...
                <div class="portfolio-item website mobile">
                    <div class="portfolio-item-inner">
                ...
                <div class="col-sm-4 col-xs-6 team-column col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        ...
                        <ul class="social-icons">
                            ...
                            <li><a href="https://id.linkedin.com/in/m-aditya-tisnadinata-27a685124" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="wow zoomIn" data-wow-duration="400ms" data-wow-delay="0ms">
                        <ul class="pricing">
                            ...
                            <li><strong>THEMED WEBSITE</strong></li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="wow zoomIn" data-wow-duration="400ms" data-wow-delay="200ms">
                        <ul class="pricing">
                            ...
                            <li><strong>THEMED WEBSITE</strong></li>
                            <li><strong>13 GB</strong> DISK SPACE</li>
                            <li><strong>UNLIMITED</strong> BANDWIDTH</li>
                            <li>SHARED SSL CERTIFICATE</li>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="wow zoomIn" data-wow-duration="400ms" data-wow-delay="400ms">
                        <ul class="pricing featured">
                            ...
                            <li><strong>FULL CUSTOM WEBSITE</strong></li>
                            <li><strong>UNLIMITED</strong> SUBDOMAIN</li>
                            <li><strong>CUSTOM</strong> DISK SPACE</li>
                            <li><strong>UNLIMITED</strong> BANDWIDTH</li>
    ...
    <section id="about">
        <div class="container">
            ...
            <div class="row">
				...
				<div class="col-sm-4 wow fadeInRight">
					<h3 class="column-title">Contact Us Here</h3>
					<div class="contact-form">
						<form id="main-contact-form" name="contact-form" method="post" action="#">
							...
							<div class="form-group">
								<input type="email" name="email" class="form-control" placeholder="Your Active Email" required>
							</div>
							<div class="form-group">
